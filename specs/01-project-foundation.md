...
Create the minimal backend foundation for APHARMA so the Express API can run locally and return a health response.
...
Do not add database, auth,  migration, or seed scripts yet.
